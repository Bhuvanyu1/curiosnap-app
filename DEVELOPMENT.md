...
```bash
git remote add encore encore://curiosnap-app-o9m2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/curiosnap-app-o9m2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/curiosnap-app-o9m2/settings/integrations/github)
